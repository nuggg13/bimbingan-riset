        ...
        <form method="POST" action="{{ route('mentor.catatan-bimbingan.update', $catatan->id_catatan) }}" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="hasil_bimbingan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('hasil_bimbingan') border-red-500 @enderror">{{ old('hasil_bimbingan', $catatan->hasil_bimbingan) }}</textarea>
            ...
            <div>
                ...
                <textarea name="tugas_perbaikan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('tugas_perbaikan') border-red-500 @enderror">{{ old('tugas_perbaikan', $catatan->tugas_perbaikan) }}</textarea>
            ...
            <div>
                ...
                <textarea name="catatan_tambahan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('catatan_tambahan') border-red-500 @enderror">{{ old('catatan_tambahan', $catatan->catatan_tambahan) }}</textarea>
