...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <a href="{{ route('mentor.catatan-bimbingan.show', $catatan->id_catatan) }}" class="text-green-600 hover:text-green-700 mr-4">
    ...
    <!-- Form -->
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form method="POST" action="{{ route('mentor.catatan-bimbingan.update', $catatan->id_catatan) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <textarea name="hasil_bimbingan" id="hasil_bimbingan" class="hidden">{{ old('hasil_bimbingan', $catatan->hasil_bimbingan) }}</textarea>
            ...
            <div>
                ...
                <textarea name="tugas_perbaikan" id="tugas_perbaikan" class="hidden">{{ old('tugas_perbaikan', $catatan->tugas_perbaikan) }}</textarea>
            ...
            <div>
                ...
                <textarea name="catatan_tambahan" id="catatan_tambahan" class="hidden">{{ old('catatan_tambahan', $catatan->catatan_tambahan) }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        ...
        if (document.getElementById('hasil_bimbingan_editor')) {
            ...
            // Set initial content from existing data
            const hasilContent = document.getElementById('hasil_bimbingan').value;
            if (hasilContent) {
                hasilEditor.root.innerHTML = hasilContent;
            }
        ...
        if (document.getElementById('tugas_perbaikan_editor')) {
            ...
            // Set initial content from existing data
            const tugasContent = document.getElementById('tugas_perbaikan').value;
            if (tugasContent) {
                tugasEditor.root.innerHTML = tugasContent;
            }
        ...
        if (document.getElementById('catatan_tambahan_editor')) {
            ...
            // Set initial content from existing data
            const catatanContent = document.getElementById('catatan_tambahan').value;
            if (catatanContent) {
                catatanEditor.root.innerHTML = catatanContent;
            }
