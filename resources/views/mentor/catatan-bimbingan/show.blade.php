                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <form method="POST" action="{{ route('mentor.catatan-bimbingan.deleteProgress', [$catatan->id_catatan, $progress->id_progress]) }}" 
...
function editProgress(id, tanggal, deskripsi, persentase) {
    ...
    form.action = `{{ route('mentor.catatan-bimbingan.updateProgress', [$catatan->id_catatan, ':id']) }}`.replace(':id', id);
