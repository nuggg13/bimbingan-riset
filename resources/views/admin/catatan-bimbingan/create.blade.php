...
<div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Buat catatan bimbingan baru untuk peserta</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Form -->
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form method="POST" action="{{ route('admin.catatan-bimbingan.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="hasil_bimbingan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('hasil_bimbingan') border-red-500 @enderror">{{ old('hasil_bimbingan') }}</textarea>
            ...
            <div>
                ...
                <textarea name="tugas_perbaikan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('tugas_perbaikan') border-red-500 @enderror">{{ old('tugas_perbaikan') }}</textarea>
            ...
            <div>
                ...
                <textarea name="catatan_tambahan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('catatan_tambahan') border-red-500 @enderror">{{ old('catatan_tambahan') }}</textarea>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.catatan-bimbingan.index') }}" 
