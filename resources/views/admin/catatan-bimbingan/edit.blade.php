...
@section('title', 'Edit Catatan Bimbingan')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <a href="{{ route('admin.catatan-bimbingan.show', $catatan->id_catatan) }}" class="text-blue-600 hover:text-blue-700 mr-4">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Edit Catatan Bimbingan</h1>
    ...
    <!-- Form -->
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form method="POST" action="{{ route('admin.catatan-bimbingan.update', $catatan->id_catatan) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <select name="id_peserta" id="id_peserta" 
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('id_peserta') border-red-500 @enderror">
                    <option value="">-- Pilih Peserta --</option>
                    @foreach($peserta as $p)
                        <option value="{{ $p->id_peserta }}" {{ (old('id_peserta', $catatan->id_peserta) == $p->id_peserta) ? 'selected' : '' }}>
                            {{ $p->nama }} - {{ $p->instansi }}
                            @if($p->pendaftaran)
            ...
            <div>
                ...
                <input type="date" 
                       ...
                       value="{{ old('tanggal_bimbingan', $catatan->tanggal_bimbingan->format('Y-m-d')) }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('tanggal_bimbingan') border-red-500 @enderror">
            ...
            <div>
                ...
                <textarea name="hasil_bimbingan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('hasil_bimbingan') border-red-500 @enderror">{{ old('hasil_bimbingan', $catatan->hasil_bimbingan) }}</textarea>
            ...
            <div>
                ...
                <textarea name="tugas_perbaikan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('tugas_perbaikan') border-red-500 @enderror">{{ old('tugas_perbaikan', $catatan->tugas_perbaikan) }}</textarea>
            ...
            <div>
                ...
                <textarea name="catatan_tambahan" 
                          ...
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('catatan_tambahan') border-red-500 @enderror">{{ old('catatan_tambahan', $catatan->catatan_tambahan) }}</textarea>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.catatan-bimbingan.show', $catatan->id_catatan) }}" 
                   class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-6 py-3 rounded-lg text-sm font-medium transition duration-200">
                    Batal
                </a>
                <button type="submit" 
                        class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg text-sm font-medium transition duration-200">
