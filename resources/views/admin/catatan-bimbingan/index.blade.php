    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Kelola catatan dan progress bimbingan peserta</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('admin.catatan-bimbingan.export') }}" 
                   class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200">
                    <i class="fas fa-download mr-2"></i>Export
                </a>
                <a href="{{ route('admin.catatan-bimbingan.create') }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.catatan-bimbingan.destroy', $catatan->id_catatan) }}" 
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 mb-6">Mulai dengan menambahkan catatan bimbingan pertama.</p>
                <a href="{{ route('admin.catatan-bimbingan.create') }}" 
