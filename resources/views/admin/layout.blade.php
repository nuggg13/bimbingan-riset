    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex md:flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1">
                ...
                <a href="{{ route('admin.catatan-bimbingan.index') }}" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium hover:bg-blue-50 hover:text-blue-700 {{ request()->routeIs('admin.catatan-bimbingan.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700' }}">
