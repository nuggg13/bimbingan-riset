...
<div class="mb-6">
    ...
    <div class="mt-4">
        <h2 class="text-2xl font-bold text-gray-900">Tambah Mentor Baru</h2>
        <p class="text-gray-600">Tambahkan mentor baru untuk bimbingan riset.</p>
    </div>
</div>
...
<div class="bg-white shadow rounded-lg">
    ...
    <form method="POST" action="{{ route('admin.mentor.store') }}" class="px-6 py-6 space-y-6">
        @csrf
        ...
        <div>
            ...
            <textarea name="keahlian" 
                      ...
                      placeholder="Deskripsikan keahlian mentor, misalnya: Machine Learning, Data Science, Web Development, Mobile Development, dll.">{{ old('keahlian') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (keahlianField) {
        ...
        keahlianField.addEventListener('input', function() {
